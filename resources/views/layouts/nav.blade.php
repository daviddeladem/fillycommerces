...
<div class="sidebar-wrapper" data-simplebar="true">
    <div class="sidebar-header">
        <div>
            <img src="assets/images/faviccon.png" width="20" alt="logo icon">
        </div>
        <div>
            <h5 class="logo-text">Filly Commerce</h5>
        </div>
    ...
    <ul class="metismenu" id="menu">
        ...
        <li>
            ...
            <ul>
                <li> <a href="{{ url('ecommerce-add-new-products') }}"><i class="bx bx-right-arrow-alt"></i>Add
                        Products</a>
                </li>
                <li> <a href="{{ url('ecommerce-products') }}"><i class="bx bx-right-arrow-alt"></i>Product List</a>
                </li>
                {{-- <li> <a href="{{ url('ecommerce-products-details') }}"><i class="bx bx-right-arrow-alt"></i>Product
                        Details</a>
                </li> --}}

                <li> <a href="{{ url('ecommerce-orders') }}"><i class="bx bx-right-arrow-alt"></i>Categories</a>
                </li>
                <li> <a href="{{ url('ecommerce-orders') }}"><i class="bx bx-right-arrow-alt"></i>Brands</a>
                </li>
            </ul>
        </li>
        <li>
            ...
            <ul>
                {{-- <li> <a href="{{ url('ecommerce-orders') }}"><i class="bx bx-right-arrow-alt"></i>Orders Lists</a>
                </li>
                <li> <a href="{{ url('ecommerce-orders') }}"><i class="bx bx-right-arrow-alt"></i>Brands</a>
                </li> --}}
        ...
        <li>
            ...
            <ul>
                ...
                <li> <a href="{{ url('content-text-utilities') }}"><i class="bx bx-right-arrow-alt"></i>Text
                        Utilities</a>
                </li> --}}
            </ul>
        </li>
        <li>
            ...
            <ul>
                ...
                <li> <a href="{{ url('icons-feather-icons') }}"><i class="bx bx-right-arrow-alt"></i>Feather
                        Icons</a>
                </li> --}}
            </ul>
        </li>
        ...
        <li>
            <a href="{{ url('user-profile') }}">
                ...
                <div class="menu-title">Hot Offers</div>
            </a>
        </li>
        {{-- <li>
            <a href="{{ url('timeline') }}">
