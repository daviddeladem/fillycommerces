                            ...
                            <div class="card-body">
                                <div class="p-4 rounded">
                                    ...
                                    <div class="form-body">
                                        <div class="col-md-12 text-center mb-3">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="inlineRadioOptions"
                                                    id="p-radio" value="option1" checked>
                                                <label class="form-check-label" for="p-radio">Personal
                                                    account</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="inlineRadioOptions"
                                                    id="b-radio" value="option2">
                                                <label class="form-check-label" for="b-radio">Business
                                                    account</label>
                                                <span
                                                    tooltip="Why Business Account?&#10;
                                                You are a business &#10;
                                                You regularly buy and sell in large quanities">
                                        ...
                                        <form class="row g-3" style="display: none" id="business">
                                            ...
                                            <div class="col-12">
                                                <label for="inputEmailAddress" class="form-label">Business Email
                                                    Address</label>
                                                <input type="email" class="form-control" name="email"
                                                    id="inputEmailAddress" placeholder="Business Email">
                                            </div>
                                            <div class="col-12">
                                                <label for="inputChoosePassword" class="form-label">Password</label>
                                                <div class="input-group" id="show_hide_password">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <select class="form-select" id="inputSelectCountry"
                                                    aria-label="Default select example" name="country">
                                                    <option value="" disabled selected hidden>Select a Country
                                                    </option>
                                                    <option value="AF">Afghanistan</option>
                                                    <option value="AX">Åland Islands</option>
                                                    <option value="AL">Albania</option>
